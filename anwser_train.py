...
max_token_id = wordToken.load_file_list(['./dialog/question', './dialog/answer'], min_freq)
...
def get_train_set():
    ...
    train_set = []
    with open('./dialog/question', 'r', encoding='utf-8') as question_file:
        with open('./dialog/answer', 'r', encoding='utf-8') as answer_file:
            while True:
...
def seq_to_encoder(input_seq):
    ...
    target_weights = [np.array([1.0], dtype=np.float)] * output_seq_len
    return encoder_inputs, decoder_inputs, target_weights
...
def train():
    ...
    with tf.Session() as sess:
        ...
        for step in range(epochs):
            ...
            #print ('sample_encoder_inputs ' + str(len(sample_encoder_inputs)))
            input_feed = {}
